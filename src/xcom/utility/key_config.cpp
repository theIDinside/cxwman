...
namespace cx::config
{
    ...
    bool operator==(const KeyConfiguration& lhs, const KeyConfiguration& rhs) { return lhs.symbol == rhs.symbol && lhs.modifier == rhs.modifier; }
    bool operator>(const KeyConfiguration& lhs, const KeyConfiguration& rhs) { return !(lhs < rhs); }
